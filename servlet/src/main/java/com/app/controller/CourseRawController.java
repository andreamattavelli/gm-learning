...
import com.app.view.CourseRawLayout;

public class CourseRawController implements Controller {
	...
	public void execute(Context context) throws Exception {
		...
		context.response().getWriter().write(new CourseRawLayout().build(seminar));
	}
